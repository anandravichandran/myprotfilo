...
const sendEmail = (e) =>{
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
      ...
      contactMessage.textContent = 'Write all the input fields  📩'
        ...
        emailjs.sendForm('service_2xc6fxh','template_0alqdff','#contact-form','KfF_jMPzOnTRVFtfS')
        .then(() =>{
...
const scrollUp = () =>{
  ...
  // when the scroll is higher than 350 viewpoint height and the show-scroll class to
...
sr.reveal('.qualification__content, .services__card',{ origin:'left', interval: 100})